...
class Ui_AboutDialog(object):
    def setupUi(self, AboutDialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/Icons/bot_icon.jpg")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.about_image_label.setPixmap(QtGui.QPixmap(_fromUtf8(":/Images/about_image.jpg")))
